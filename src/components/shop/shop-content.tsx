        ...
        <div className="mx-auto max-w-7xl px-4 pt-16 sm:px-6 lg:px-8">
          <Reveal>
            <SectionHeading
              ...
              description="Nutrition, musculation, sèche, prise de masse et recettes premium : des guides pratiques et actionnables. Téléchargement immédiat, mises à jour incluses."
            />
          </Reveal>
          <Reveal delay={0.1}>
