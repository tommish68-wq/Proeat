...
export function PremiumContent() {
  ...
  return (
    <div>
      {/* ---------- En-tête sombre ---------- */}
      <section className="noise relative -mt-16 overflow-hidden bg-[#2a454f] pb-40 pt-32">
        <Orb
          className="blur-3xl"
          style={{ top: "0%", right: "8%", width: 300, height: 300, background: "radial-gradient(circle at 40% 40%, rgba(217,197,165,0.35), transparent 70%)" }}
          duration={12}
          dy={26}
        />
        <Orb
          className="blur-3xl"
          style={{ bottom: "-10%", left: "0%", width: 340, height: 340, background: "radial-gradient(circle at 40% 40%, rgba(94,124,116,0.3), transparent 70%)" }}
          duration={14}
          dy={-24}
          delay={1}
        />
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6">
          <motion.span
            ...
            className="glass inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold text-[#d9c5a5]"
          >
          ...
          >
            <button
              ...
              className={`rounded-full px-5 py-2 text-sm font-semibold transition-all ${
                !yearly ? "bg-white text-[#2a454f]" : "text-white/70 hover:text-white"
              }`}
            >
              Mensuel
            </button>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Reveal delay={0.1}>
            <TiltCard max={4} className="h-full">
              <div className="noise relative flex h-full flex-col overflow-hidden rounded-3xl bg-[#2a454f] p-8 shadow-glow">
                <div
                  aria-hidden
                  className="absolute inset-0"
                  style={{
                    background:
                      "radial-gradient(24rem 14rem at 85% -10%, rgba(163,123,77,0.3), transparent 62%), radial-gradient(20rem 12rem at 0% 110%, rgba(94,124,116,0.35), transparent 62%)",
                  }}
                />
                <div className="relative flex h-full flex-col">
                  ...
                  <ul className="mt-6 flex-1 space-y-3">
                    <li className="text-xs font-semibold uppercase tracking-wide text-[#c6d6d3]">
                      Tout le gratuit, plus :
                    </li>
                    {premiumFeatures.map((f) => (
                      <li key={f} className="flex items-start gap-2.5 text-sm leading-relaxed text-white/90">
                        <Check className="mt-0.5 h-4 w-4 shrink-0 text-[#d9c5a5]" />
                        {f}
                      </li>
                    ))}
                  </ul>
                  <button
                    ...
                    className="group mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-bold text-[#2a454f] shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
                  >
